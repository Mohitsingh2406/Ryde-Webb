      ...
      <div className='flex flex-col justify-end  h-screen  absolute top-0 w-full'>
        ...
        <form onSubmit={(e)=>{
          ...
          <input type="text" onClick={()=>{
            setPanelOpen(true)
          }} value={pickup}  onChange={(e)=>{setPickup(e.target.value)}} className='bg-[#eee] px-12 py-2 text-lg rounded-lg w-full' placeholder='Add a pick-up location'/>
          <input type="text" onClick={()=>{
            setPanelOpen(true)
          }} value={destination} onChange={(e)=>{setDestination(e.target.value)}} className='bg-[#eee] px-12 py-2 text-lg rounded-lg w-full  mt-3' placeholder='Enter Your destination'/>
        </form>
        </div>
